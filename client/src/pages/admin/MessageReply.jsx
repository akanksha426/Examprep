          ...
          <div className="card  rounded-4 overflow-hidden mt-3">
            <table className="table  table-bordered align-middle mb-0">
              <thead className="table-primary text-center">
                <tr>
                  <th colSpan={5} className="fw-bold fs-5">ADMIN-USER MESSAGE REPLY</th>
                </tr>
                <tr>
            <th>S.No.</th>
            <th>Examinee</th>
              ...
              <tr key={msg._id}>
                ...
                <td style={{ minWidth: 250 }}>
                  ...
                  <div className="d-flex gap-1">
                    ...
                    <button className=" btn-sm btn-edit" onClick={() => editReply(msg._id, msg.answer)}><FaEdit/></button>
                    <button className=" btn-sm btn-delete" onClick={() => deleteByAdmin(msg._id)}><FaTrash/></button>
                  </div>
                </td>
              </tr>
            ))
