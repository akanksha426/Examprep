          ...
          {messages.length === 0 ? (
            ...
            messages.map((msg, idx) => (
              <tr key={msg._id}>
                ...
                <td>
                  <button className="btn btn2 btn-sm  me-1" onClick={() => editMyMessage(msg._id, msg.question)}>Edit</button>
                  <button className="btn btn3 btn-sm " onClick={() => deleteByUser(msg._id)}>Delete</button>
                </td>
              </tr>
            ))
          )}
